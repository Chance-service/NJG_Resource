...
-------------------------------------------------------
--[[ NEW
對物理防禦力最低敵方單體造成250%/350%/450%(params1)傷害，自身有"隱身"(params2)時必定爆擊
]]--
--[[ OLD
對血量最低敵方單體造成每下250%/300%/350%(params1)傷害，最後一下傷害必定暴擊，
Lv3時每次攻擊有50%(params2)機率傷害變為2倍(params3)
]]--
-------------------------------------------------------
...
function Skill_1230:getisStealth(chaNode, skillId)
    ...
    for fullBuffId, buffData in pairs(chaNode.buffData) do
        ...
        if mainBuffId == tonumber(params[2]) then  -- 隱身
            return true
        end
    end
    return false
