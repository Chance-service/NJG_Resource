...
-------------------------------------------------------
--[[ NEW
對當前目標造成300%/400%/500%(params1)傷害，並賦予自身"狂戰士I/狂戰士II/狂戰士III"(params2)6/7/8秒(params3)
]]--
--[[ OLD
對前方橢圓形區域(w:200(params1), h:180(params2))內敵人造成
250%/280%/310%(params3)物理傷害，並根據敵方場上存活職業獲得對應BUFF10秒(params8)
坦克 : "獵魔人I式"(params4)
戰士/法師 : "獵魔人II式"(params5)
輔助 : "獵魔人III式"(params6), 對目標賦予"禁療"(params7)
]]--
-------------------------------------------------------
function Skill_1200:castSkill(chaNode, skillType, skillId)
    --紀錄skill data
...
-- 提前計算技能目標用 不使用時回傳nil
function Skill_1200:calSkillTarget(chaNode, skillId)
    return nil
end
function Skill_1200:runSkill(chaNode, skillId, resultTable, allPassiveTable, targetTable, attack_params)
    local skillCfg = ConfigManager:getSkillCfg()[skillId]
...
function Skill_1200:getSkillTarget(chaNode, skillId)
