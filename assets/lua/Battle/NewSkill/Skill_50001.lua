...
-------------------------------------------------------
--[[
對敵方全體造成100/120/140/160/180/200/220%(params1)傷害，並賦予"猛毒I/猛毒I/猛毒I/猛毒II/猛毒II/猛毒II/猛毒III"(params2)8秒(params3)
驅散自身所有負面狀態
]]--
-------------------------------------------------------
function Skill_50001:castSkill(chaNode, skillType, skillId)
    --紀錄skill data
...
-- 提前計算技能目標用 不使用時回傳nil
function Skill_50001:calSkillTarget(chaNode, skillId)
    return nil
end
function Skill_50001:runSkill(chaNode, skillId, resultTable, allPassiveTable, targetTable, attack_params)
    local skillCfg = ConfigManager:getSkillCfg()[skillId]
...
function Skill_50001:getSkillTarget(chaNode, skillId)
