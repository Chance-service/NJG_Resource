...
-------------------------------------------------------
--[[ NEW
對當前目標造成每下100%/120%/140%(params1)傷害，並賦予自身"怒氣I/怒氣II/怒氣III"(params2)5/6/7秒(params3)，此攻擊必定命中
]]--
--[[ OLD
對隨機敵方單體造成每下160%/190%/220%(params1)傷害，並賦予"暈眩"(params2)1/1/2秒(params3)，此攻擊必定命中
]]--
-------------------------------------------------------
function Skill_1040:castSkill(chaNode, skillType, skillId)
    --紀錄skill data
...
-- 提前計算技能目標用 不使用時回傳nil
function Skill_1040:calSkillTarget(chaNode, skillId)
    return nil
end
function Skill_1040:runSkill(chaNode, skillId, resultTable, allPassiveTable, targetTable, attack_params)
    local skillCfg = ConfigManager:getSkillCfg()[skillId]
...
function Skill_1040:getSkillTarget(chaNode, skillId)
