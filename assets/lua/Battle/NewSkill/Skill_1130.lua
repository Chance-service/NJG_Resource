...
-------------------------------------------------------
--[[ NEW
對敵方全體造成150%/180%/220%(params1)傷害，並賦予目標"猛毒I/猛毒II/猛毒III"(params2)8/10/12秒(params3)
]]--
--[[ OLD
對敵方全體造成130%/150%/170%(params1)傷害，並賦予目標"嘲諷"(params2)及自身"守護III/守護III/守護V"(params3)5/6/6秒(params4)
]]--
-------------------------------------------------------
function Skill_1130:castSkill(chaNode, skillType, skillId)
    --紀錄skill data
...
-- 提前計算技能目標用 不使用時回傳nil
function Skill_1130:calSkillTarget(chaNode, skillId)
    return nil
end
function Skill_1130:runSkill(chaNode, skillId, resultTable, allPassiveTable, targetTable, attack_params)
    local skillCfg = ConfigManager:getSkillCfg()[skillId]
...
function Skill_1130:getSkillTarget(chaNode, skillId)
