...
-------------------------------------------------------
--[[ NEW
對敵方全體造成200%/300%/400%(params1)傷害，並對友方全體造成100%/150%/200%(params2)傷害
]]--
--[[ OLD
優先選擇祭品(params3)為目標，若無祭品則選擇當前目標，
第一Hit對目標周圍橢圓形區域(w:240(params1), h:150(params2))造成300%/350%/400%(params4)傷害，並賦予"沉默"(params5)3秒(params6)，
第二Hit若該目標存活，額外造成目標最大生命3%/3%/5%(params7)的傷害，
當光3在場上時額外傷害變為2倍(params8)
]]--
-------------------------------------------------------
