...
-------------------------------------------------------
--[[
對敵方全體造成380%/380%/380%/380%/380%(params1)傷害，並賦予"侵蝕I"(params2)6秒(params3)，
賦予友方全體"不屈"(params4)7秒(params5)
]]--
-------------------------------------------------------
function Skill_5040:castSkill(chaNode, skillType, skillId)
    --紀錄skill data
...
-- 提前計算技能目標用 不使用時回傳nil
function Skill_5040:calSkillTarget(chaNode, skillId)
    return nil
end
function Skill_5040:runSkill(chaNode, skillId, resultTable, allPassiveTable, targetTable, attack_params)
    local skillCfg = ConfigManager:getSkillCfg()[skillId]
...
function Skill_5040:isUsable(chaNode, skillType, skillId, triggerType)
    return true
end
