...
-------------------------------------------------------
--[[ NEW
對敵方全體造成100%/100%/100%(params1)傷害，並賦予目標"沉默"(params2)3秒/4秒/5秒(params3)
]]--
--[[ OLD
消耗自身當前共25%/25%/35%(params1)生命，對敵方全體造成消耗生命50%/60%/70%(params2)傷害，當前生命低於60%(params3)時無法使用
]]--
-------------------------------------------------------
function Skill_1151:castSkill(chaNode, skillType, skillId)
    --紀錄skill data
...
-- 提前計算技能目標用 不使用時回傳nil
function Skill_1151:calSkillTarget(chaNode, skillId)
    return nil
end
function Skill_1151:runSkill(chaNode, skillId, resultTable, allPassiveTable, targetTable, attack_params)
    local skillCfg = ConfigManager:getSkillCfg()[skillId]
...
function Skill_1151:isUsable(chaNode, skillType, skillId, triggerType)
...
function Skill_1151:getSkillTarget(chaNode, skillId)
