...
local SKILLINFO_EXP_FIELD = protobuf.FieldDescriptor();
...
SKILLINFO_EXP_FIELD.full_name = ".SkillInfo.exp"
SKILLINFO_EXP_FIELD.number = 6
SKILLINFO_EXP_FIELD.index = 5
SKILLINFO_EXP_FIELD.label = 1
SKILLINFO_EXP_FIELD.has_default_value = false
SKILLINFO_EXP_FIELD.default_value = 0
SKILLINFO_EXP_FIELD.type = 5
SKILLINFO_EXP_FIELD.cpp_type = 1

SKILLINFO.name = "SkillInfo"
SKILLINFO.full_name = ".SkillInfo"
SKILLINFO.nested_types = {}
SKILLINFO.enum_types = {}
SKILLINFO.fields = {SKILLINFO_ROLEID_FIELD, SKILLINFO_ID_FIELD, SKILLINFO_ITEMID_FIELD, SKILLINFO_SKILLLEVEL_FIELD, SKILLINFO_STATUS_FIELD, SKILLINFO_EXP_FIELD}
