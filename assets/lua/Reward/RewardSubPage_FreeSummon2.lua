...
local opcodes = {
    ACTIVITY180_FREE_SUMMON_S=HP_pb.ACTIVITY180_FREE_SUMMON_S,
...
function DayLogin30Item:onAutoClick()
    if self.mState == DayLogin30ItemState.CanGet then
        ...
        msg.action = 1
        common:sendPacket(HP_pb.ACTIVITY180_FREE_SUMMON_C, msg, false)
    end
end
...
function DayLogin30Page:initData()
    ...
    configData = ConfigManager.getFreeSummonData2()
...
function DayLogin30Page:onReceivePacket(packet)
    ...
    if opcode == HP_pb.ACTIVITY180_FREE_SUMMON_S then
...
function DayLogin30Page:AllSigned()
   return serverData.signedDays == #ConfigManager.getFreeSummonData2()
end
--
