...
local opcodes = {
    EXCHANGE_SHOP_INFO_C = HP_pb.EXCHANGE_SHOP_INFO_C,
    EXCHANGE_SHOP_INFO_S = HP_pb.EXCHANGE_SHOP_INFO_S,
    DO_EXCHANGE_SHOP_C = HP_pb.DO_EXCHANGE_SHOP_C,
    DO_EXCHANGE_SHOP_S = HP_pb.DO_EXCHANGE_SHOP_S,
...
function GoodsExchangePage:getPageInfo(index)
    ExchangeActivityCfg = { }
    ExchangeActivityCfg.cfg = ConfigManager.getExchangeActivityItem_136()
